...
public class TC_Signup_20 extends TestBase {
    @SuppressWarnings("unchecked")
    @BeforeClass
    @Parameters({"first_name_valid", "last_name_valid", "phone_unregistered", "pass_valid"})
    void SettingUp(String first_name, String last_name, String phone, String pass){
