...
public class TC_Signup_18 extends TestBase {
    @SuppressWarnings("unchecked")
    @BeforeClass
    @Parameters({"first_name_valid", "phone_unregistered", "email_unregistered", "pass_valid"})
    void SettingUp(String first_name, String phone, String email, String pass){
